...
export async function createOrganization(input: CreateOrganizationInput) {
  ...
  console.log("[createOrganization] Creating organization with nested membership:", { name, slug, userId });

  // Create organization with nested membership in a single transaction
